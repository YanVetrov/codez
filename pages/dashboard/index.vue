                            ...
                            <div class="row p-t-30">
                                <div class="col-sm-6">
                                    <ul class="side-icon-text">
                                        <li><span class="di vm"><i class="wi wi-day-hail text-info"></i></span><span
                                                class="di vm"><h1 class="m-b-0 text-info">23<sup>o</sup></h1><h5
                                                class="m-t-0">Mostly Sunny</h5></span></li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                    ...
                    <div class="panel">
                        <div class="row">
                            <ul class="list-unstyled city-weather-days">
                                <li class="col-xs-4 col-sm-2"><span>Tue</span><i
                                        class="wi wi-day-sunny"></i><span>32<sup>°F</sup></span></li>
                                <li class="col-xs-4 col-sm-2"><span>Wed</span><i
                                        class="wi wi-day-cloudy"></i><span>34<sup>°F</sup></span></li>
                                <li class="col-xs-4 col-sm-2"><span>Thu</span><i
                                        class="wi wi-day-hail"></i><span>35<sup>°F</sup></span></li>
                                <li class="col-xs-4 col-sm-2 active"><span>Fri</span><i
                                        class="wi wi-day-sprinkle"></i><span>34<sup>°F</sup></span></li>
                                <li class="col-xs-4 col-sm-2"><span>Sat</span><i
                                        class="wi wi-day-snow"></i><span>30<sup>°F</sup></span></li>
                                <li class="col-xs-4 col-sm-2"><span>Sun</span><i
                                        class="wi wi-day-sunny"></i><span>26<sup>°F</sup></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="carousel-inner">
                                <div class="active item">
                                    ...
                                    <div class="news-content"><span
                                            class="label label-danger label-rounded">Primary</span>
                                ...
                                <div class="item">
                                    ...
                                    <div class="news-content"><span
                                            class="label label-primary label-rounded">Primary</span>
                                        <h2>It has survived not only five centuries, but also the leap into electronic
                                            typesetting, remaining essentially unchanged.</h2> <a href="#">Read More</a>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="overlaybg"><img src="../../static/images/heading-bg/slide6.jpg"/></div>
                                    <div class="news-content"><span
                                            class="label label-success label-rounded">Primary</span>
                                        <h2>It has survived not only five centuries, but also the leap into electronic
                                            typesetting, remaining essentially unchanged.</h2> <a href="#">Read More</a>
                                    </div>
                                </div>
                            ...
                            <table class="table table-hover manage-u-table">
                                ...
                                <tr v-for="list in lists" :key="list.key">
                                    ...
                                    <td>4234.2 RUB
                                        <br/><span class="text-muted">230.3 USD</span></td>
                                    <td>
                                        <button type="button" class="btn btn-info btn-outline btn-circle btn-s m-r-5"><i
                                                class="ti-check"></i></button>
                                        <button type="button" class="btn btn-info btn-outline btn-circle btn-s m-r-5"><i
                                                class="ti-money"></i></button>
                                        <button type="button" class="btn btn-info btn-outline btn-circle btn-s m-r-5"><i
                                                class="ti-back-left"></i></button>
                                        <button type="button" class="btn btn-info btn-outline btn-circle btn-s m-r-20">
                                            <i class="ti-trash"></i></button>
                                        <button type="button"
                                                class="btn btn-info btn-outline btn-rectangle btn-s m-r-20">INFO
                                        </button>
