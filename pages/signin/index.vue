                  ...
                  <form class="form-horizontal new-lg-form" id="loginform" action="index.html">
                    ...
                    <div class="form-group  m-t-20">
                      <div class="col-xs-12">
                        ...
                        <input class="form-control" type="text" v-model="login" required="" placeholder="Username">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-xs-12">
                        <label>Password</label>
                        <input class="form-control" v-model="password" type="password" required="" placeholder="Password">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-md-12">
