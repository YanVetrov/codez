...
// With node.js on Windows: use symbols available in terminal default font
 ...
 * as well as user-defined colors
 * schemes.
 *
 * @param {String} type
 * @param {String} str
...
/**
 * Color lines for `str`, using the colors `name`.
 *
 * @param {String} name
 * @param {String} str
 * @return {String}
