...
var handleButton = function handleButton(event, params, modal) {
  ...
  // Since the user can change the background-colors of the confirm button programmatically,
  // we must calculate what the colors should be on hover/active
...
/*
 * Add box-shadow style to button (depending on its chosen bg-colors)
 */
...
var setParameters = function setParameters(params) {
  ...
  /*
   * Custom colors on confirm button
   */
  if (params.confirmButtonColor) {
    // Set confirm button to selected background colors
    $confirmBtn.style.backgroundColor = params.confirmButtonColor;

    // Set the confirm button colors to the loading ring
