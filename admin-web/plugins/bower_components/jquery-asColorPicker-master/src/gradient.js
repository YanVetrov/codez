    ...
    var Gradient = function(api, options) {
        ...
        $.extend(self, {
            ...
            bind: function() {
                ...
                //         api._trigger('update', data.stop.colors, self.value);
                //         api._updateInput();
                //     }
                // });
            ...
            markers: {
                ...
                add: function(stop) {
                    $('<li data-id="' + stop.id + '" style="left:' + conventToPercentage(stop.position) + '" class="' + self.classes.marker + '"><span style="background-colors: ' + stop.color.toHEX() + '"></span><i style="background-colors: ' + stop.color.toHEX() + '"></i></li>').appendTo(self.$markers);
                },
                empty: function() {
                    self.$markers.html('');
                },
                ...
                active: function(id) {
                    ...
                    self.$markers.focus();
                    // self.api._trigger('apply', self.value.getById(id).colors);
                },
