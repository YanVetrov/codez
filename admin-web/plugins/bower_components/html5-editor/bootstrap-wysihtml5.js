!function($, wysi) {
    ...
    var tpl = {
        ...
        "color": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btn dropdown-toggle" + size + "' data-toggle='dropdown' href='#'>" +
                "<span class='current-colors'>" + locale.colours.black + "</span>&nbsp;<b class='caret'></b>" +
              "</a>" +
              "<ul class='dropdown-menu'>" +
    ...
    Wysihtml5.prototype = {
        ...
        createToolbar: function(el, options) {
            ...
            toolbar.find("a[data-wysihtml5-command='foreColor']").click(function(e) {
                var target = e.target || e.srcElement;
                var el = $(target);
                self.toolbar.find('.current-colors').text(el.html());
            });
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        parserRules: {
            classes: {
                // (path_to_project/lib/css/wysiwyg-colors.css)
        ...
        stylesheets: ["./lib/css/wysiwyg-colors.css"], // (path_to_project/lib/css/wysiwyg-colors.css)
        locale: "en"
    };
