...
(function (glob, factory) {
     ...
     * Raphael.colors
     [ method ]
     **
     * Parses the colors string and returns object with all values for the given colors.
     > Parameters
     - clr (string) colors string in one of the supported formats (see @Raphael.getRGB)
     = (object) Combined RGB & HSB object in format:
     o {
     o     r (number) red,
     o     g (number) green,
     o     b (number) blue,
     o     hex (string) colors in HTML/CSS format: #••••••,
     ...
     **
     ...
     o     colors (string) glow colour, default is `black`
     o }
