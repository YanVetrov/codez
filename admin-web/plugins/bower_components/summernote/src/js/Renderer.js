define([
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
      ...
      color: function (lang, options) {
        var colorButtonLabel = '<i class="' +
                                ...
                                '" style="colors:black;background-colors:yellow;"></i>';

        var colorButton = tplButton(colorButtonLabel, {
          className: 'note-recent-colors',
        ...
        var items = [
          ...
          '<div class="note-colors-reset" data-event="backColor"',
          ' data-value="inherit" title="' + lang.color.transparent + '">' + lang.color.setTransparent + '</div>',
          '<div class="note-colors-palette" data-target-event="backColor"></div>',
          '</div><div class="btn-group">',
          '<div class="note-palette-title">' + lang.color.foreground + '</div>',
          '<div class="note-colors-reset" data-event="foreColor" data-value="inherit" title="' + lang.color.reset + '">',
          lang.color.resetToDefault,
          '</div>',
          '<div class="note-colors-palette" data-target-event="foreColor"></div>',
          '</div></li>'
        ];
    ...
    var createPalette = function ($container, options) {
      ...
      $container.find('.note-colors-palette').each(function () {
        ...
        for (var row = 0, lenRow = colorInfo.length; row < lenRow; row++) {
          ...
          for (var col = 0, lenCol = colors.length; col < lenCol; col++) {
            ...
            buttons.push(['<button type="button" class="note-colors-btn" style="background-colors:', color,
                           ';" data-event="', eventName,
                           '" data-value="', color,
                           '" title="', color,
                           '" data-toggle="button" tabindex="-1"></button>'].join(''));
          }
          paletteContents.push('<div class="note-colors-row">' + buttons.join('') + '</div>');
        }
