        ...
        <div class="navbar-header">
            <div class="top-left-part">
                ...
                <a class="logo" href="index.html">
                    ...
                    <!--This is dark logo icon--><img src="../../static/images/admin-logo.png" alt="home"
                                                      class="dark-logo"/>
                    <!--This is light logo icon--><img src="../../static/images/admin-logo-dark.png" alt="home"
                                                       class="light-logo"/>
                </b>
                    ...
                    <ul class="dropdown-menu mailbox animated bounceInDown">
                        ...
                        <li>
                            <div class="message-center">
                                ...
                                <a href="#">
                                    <div class="user-img"><img src="../../static/images/users/sonu.jpg" alt="user"
                                ...
                                <a href="#">
                                    <div class="user-img"><img src="../../static/images/users/arijit.jpg" alt="user"
                                                               class="img-circle">
