    ...
    <div class="row">
        <div class="col-md-12">
            <div class='white-box'>
                ...
                <br/>
                <button class='btn btn-info btn-outline btn-rectangle btn-s m-r-14'
                        @click="save(rule.content,rule.title)">{{$t('save')}}
                </button>
                <button class='btn btn-info btn-outline btn-rectangle btn-s m-r-14' @click="rule.content=''">
                    {{$t('clear')}}
                </button>
